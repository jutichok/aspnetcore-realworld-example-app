...
namespace C3
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = _config.GetValue<string>("ASPNETCORE_C3_ConnectionString") ??
            ...
            var databaseProvider = _config.GetValue<string>("ASPNETCORE_C3_DatabaseProvider");
            if (string.IsNullOrWhiteSpace(databaseProvider))
            {
                databaseProvider = DEFAULT_DATABASE_PROVIDER;
            }

            services.AddDbContext<C3Context>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.ApplicationServices.GetRequiredService<C3Context>().Database.EnsureCreated();
        }
    }
}