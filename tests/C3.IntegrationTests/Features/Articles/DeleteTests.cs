...
using C3.IntegrationTests.Features.Comments;
using C3.IntegrationTests.Features.Users;

namespace C3.IntegrationTests.Features.Articles
{
    public class DeleteTests : SliceFixture
    {
        ...
        public async Task Expect_Delete_Article_With_Comments()
        {
            ...
            var createCommentCmd = new C3.Features.Comments.Create.Command()
            {
                Comment = new C3.Features.Comments.Create.CommentData()
                {
