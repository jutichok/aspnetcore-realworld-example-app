...
{
    public class C3Context : DbContext
    {
        private IDbContextTransaction _currentTransaction;

        public C3Context(DbContextOptions options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FollowedPeople>(b =>
            {
                ...
                // app.ApplicationServices.GetRequiredService<C3Context>().Database.EnsureCreated(); throws the following error:
